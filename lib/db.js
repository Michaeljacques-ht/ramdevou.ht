...
function seed() {
  ...
  return { users, entreprises, services, employes, rendezvous, avis, notifications, chambres: [], sejours: [], carte: [], tarifs: [], saisons: [], programmes: [], inscriptions: [], dossiers: [], produits: [], commandes: [], messages: [], paiements: [], portefeuilles: [], retraits: [], sessions: {} };
}
