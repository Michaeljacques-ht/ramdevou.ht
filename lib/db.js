...
function seed() {
  ...
  return { users, entreprises, services, employes, rendezvous, avis, notifications, chambres: [], sejours: [], carte: [], programmes: [], inscriptions: [], dossiers: [], produits: [], commandes: [], paiements: [], portefeuilles: [], retraits: [], sessions: {} };
}
